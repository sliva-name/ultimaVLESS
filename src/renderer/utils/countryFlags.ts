...
const COUNTRY_CODE_MAP: Record<string, string> = {
  ...
  'AT': 'AT', 'Austria': 'AT', 'Österreich': 'AT', 'Австрия': 'AT',
  'SE': 'SE', 'Sweden': 'SE', 'Sverige': 'SE',
  'NO': 'NO', 'Norway': 'NO', 'Norge': 'NO',
  'DK': 'DK', 'Denmark': 'DK', 'Danmark': 'DK',
  'FI': 'FI', 'Finland': 'FI', 'Suomi': 'FI',
  'EE': 'EE', 'EST': 'EE', 'Estonia': 'EE', 'Eesti': 'EE',
  'LV': 'LV', 'LVA': 'LV', 'Latvia': 'LV', 'Latvija': 'LV',
  'LT': 'LT', 'LTU': 'LT', 'Lithuania': 'LT', 'Lietuva': 'LT',
  ...
  'RU': 'RU', 'RUS': 'RU', 'Russia': 'RU', 'Россия': 'RU', 'Russian': 'RU', 'Russian Federation': 'RU',
  'UA': 'UA', 'Ukraine': 'UA', 'Україна': 'UA',
  'TR': 'TR', 'Turkey': 'TR', 'Türkiye': 'TR',
  'JP': 'JP', 'Japan': 'JP', '日本': 'JP',
  'KR': 'KR', 'Korea': 'KR', 'South Korea': 'KR', '한국': 'KR',
  'CN': 'CN', 'China': 'CN', '中国': 'CN',
  'SG': 'SG', 'Singapore': 'SG', '新加坡': 'SG',
  'HK': 'HK', 'Hong Kong': 'HK', '香港': 'HK',
  'TW': 'TW', 'Taiwan': 'TW', '台灣': 'TW',
  'IN': 'IN', 'India': 'IN', 'भारत': 'IN',
  'TH': 'TH', 'Thailand': 'TH', 'ประเทศไทย': 'TH',
  'VN': 'VN', 'Vietnam': 'VN', 'Việt Nam': 'VN',
  'PH': 'PH', 'Philippines': 'PH',
  'ID': 'ID', 'Indonesia': 'ID',
  'MY': 'MY', 'Malaysia': 'MY',
  'AU': 'AU', 'AUS': 'AU', 'Australia': 'AU', 'Австралия': 'AU',
  ...
  'EG': 'EG', 'Egypt': 'EG', 'مصر': 'EG',
  'IL': 'IL', 'Israel': 'IL', 'ישראל': 'IL',
  'AE': 'AE', 'UAE': 'AE', 'United Arab Emirates': 'AE',
  'SA': 'SA', 'Saudi Arabia': 'SA', 'السعودية': 'SA',
};

// Common city names that indicate countries
const CITY_COUNTRY_MAP: Record<string, string> = {
  'New York': 'US', 'Los Angeles': 'US', 'Chicago': 'US', 'Miami': 'US', 'Dallas': 'US',
  ...
  'Lisbon': 'PT',
  'Dublin': 'IE',
  'Moscow': 'RU', 'Saint Petersburg': 'RU', 'St. Petersburg': 'RU', 'St Petersburg': 'RU',
  'Novosibirsk': 'RU', 'Yekaterinburg': 'RU', 'Kazan': 'RU', 'Nizhny Novgorod': 'RU',
  'Chelyabinsk': 'RU', 'Samara': 'RU', 'Omsk': 'RU', 'Rostov': 'RU', 'Ufa': 'RU',
  'Krasnoyarsk': 'RU', 'Voronezh': 'RU', 'Perm': 'RU', 'Volgograd': 'RU',
  'Kiev': 'UA', 'Kyiv': 'UA',
...
function extractCountryCode(text: string): string | null {
  ...
  for (const match of emojiMatches) {
    ...
    if (codePoint1 && codePoint2) {
      const code = String.fromCharCode(codePoint1 - 0x1F1E6 + 65) + 
  ...
  const code2Matches = Array.from(upperText.matchAll(/\b([A-Z]{2})(?:[-_]?\d+)?\b/g));
 ...
 */
export function getCountryCode(server: { name: string; address: string }): string | null {
